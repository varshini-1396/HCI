        ...
        <div className="mx-auto px-6 lg:px-12 max-w-[1400px] py-16">
          <div className="max-w-4xl">
            ...
            <p className="text-lg text-[#64748B] leading-relaxed">
              Manage your account preferences, accessibility options, and notification settings.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-24 space-y-2">
              <a href="#account" className="block px-4 py-3 bg-white rounded-lg border-2 border-blue-200 text-[#0A2540] font-medium hover:border-blue-400 transition-all">
                <div className="flex items-center gap-3">
                  <User className="w-5 h-5 text-blue-600" />
                  <span>Account</span>
                </div>
              </a>
              <a href="#visual" className="block px-4 py-3 bg-white rounded-lg border border-[#E5E7EB] text-[#64748B] hover:border-[#0A2540] hover:text-[#0A2540] transition-all">
                <div className="flex items-center gap-3">
          ...
          <div className="lg:col-span-3 space-y-12">
            ...
            <section id="account">
              <div className="mb-6">
                <h2 className="text-2xl text-[#0A2540] mb-2">Account Preferences</h2>
                <p className="text-[#64748B]">Manage notifications and account settings</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl p-6 border-2 border-[#E5E7EB]">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h3 className="text-lg text-[#0A2540] font-medium">Notifications</h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-[#F8FAFC] rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-[#0A2540] font-medium mb-1">Email Notifications</div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-[#F8FAFC] rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-[#0A2540] font-medium mb-1">SMS Alerts</div>
                          <div className="text-sm text-[#64748B]">Get payment reminders via SMS</div>
                        </div>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                    ...
                    <div className="flex items-center justify-between p-4 bg-[#F8FAFC] rounded-lg">
                      <div className="flex items-center gap-3">
                        <Bell className="w-5 h-5 text-[#64748B]" />
                        <div>
                          <div className="text-[#0A2540] font-medium mb-1">Push Notifications</div>
                          <div className="text-sm text-[#64748B]">Receive instant alerts</div>
                        </div>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                ...
                <div className="bg-white rounded-xl p-6 border-2 border-[#E5E7EB]">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h3 className="text-lg text-[#0A2540] font-medium">Security</h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-[#F8FAFC] rounded-lg">
                      <div>
                        <div className="text-[#0A2540] font-medium mb-1">Password</div>
                        <div className="text-sm text-[#64748B]">Last changed 2 months ago</div>
                      </div>
                      <button className="px-4 py-2 text-[#0A2540] border-2 border-[#E5E7EB] rounded-lg hover:border-[#0A2540] transition-all font-medium">
                        Change
                      </button>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-[#F8FAFC] rounded-lg">
                      <div>
                        <div className="text-[#0A2540] font-medium mb-1">Two-Factor Authentication</div>
                        <div className="text-sm text-[#64748B]">Add extra security to your account</div>
                      </div>
                      <button className="px-4 py-2 bg-[#0A2540] text-white rounded-lg hover:bg-[#0D2F52] transition-all font-medium">
                        Enable
                      </button>
                    </div>
                  </div>
